...
- Add user-selected BSPSource decompiler execution, generic wrapper escape hatch, desktop BSP-derived VMF import warnings, optional BSP packing CLI/reporting, and compile profile creation/validation/discovery and optional desktop compile launch.
