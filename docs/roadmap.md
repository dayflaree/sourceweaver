...
- Add user-selected BSPSource decompiler execution, generic wrapper escape hatch, desktop BSP-derived VMF import warnings, optional BSP packing CLI/reporting, and compile profile creation/validation/discovery, optional desktop compile launch, and real-tool smoke-test matrix.
