...
- Add user-selected BSPSource decompiler execution, generic wrapper escape hatch, desktop BSP-derived VMF import warnings, and optional BSP packing CLI/reporting.
