...
- Inspect basic MDL model headers and Source-style mesh tables, and run user-provided StudioMDL-compatible model compile tools or headless model-decompile wrappers.
